...
startup {
  ...
  int MISSION5_RUGNAME_DEAD = 1106464;
  ...
  Func<dynamic, dynamic, bool> finishedMission5RugnameTest = (thisOld, thisCurrent) => thisCurrent.isRugnameDead == MISSION5_RUGNAME_DEAD;
