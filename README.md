...
1. Click browse and find either the `default-ms3-autosplitter.asl` or `bosses-only-ms3-autosplitter.asl` file in the root of the repo you downloaded. Once you've selected it then just Ok out of all the windows that you've opened up in previous steps till you get back to your splits.
